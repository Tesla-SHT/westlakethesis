...
\par 我们可以用includegraphics来插入现有的jpg等格式的图片，如\autoref{fig:westlake-logo}。

\begin{figure}[ht]
    \centering
    \includegraphics[width=.4\linewidth]{logo/westlake}
    \caption{\label{fig:westlake-logo}西湖大学LOGO}
\end{figure}
