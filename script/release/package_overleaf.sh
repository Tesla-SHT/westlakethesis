...
dir=$1
pkgname=westlakethesis-$ver-overleaf
...
https://github.com/your-org/westlakethesis/blob/master/script/ci/setup.sh
...
git checkout config/format/major/westlake/fonts.tex
