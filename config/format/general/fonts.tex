...
\IfFileExists{ /System/Library/Fonts/PingFang.ttc }
{
    ...
    \setCJKmainfont[AutoFakeBold={\FakeBoldSize},BoldFont={Songti SC Bold}]{Songti SC Light}
}
{
    % Older MacOS
    % Fonts
...
}
{
    ...
    }
    {
        ...
        \setCJKfamilyfont{zhfs}   {FandolFang-Regular.otf} [AutoFakeBold={\FakeBoldSize}]
        \setCJKfamilyfont{zhhei}  {FandolHei-Regular.otf}  [AutoFakeBold={\FakeBoldSize}]
        \setCJKfamilyfont{zhkai}  {FandolKai-Regular.otf}  [AutoFakeBold={\FakeBoldSize}]
        \setCJKfamilyfont{zhsong} {FandolSong-Regular.otf} [AutoFakeBold={\FakeBoldSize}]
