...
\ifthenelse{\equal{\Degree}{undergraduate}}
{
    ...
    \renewcommand{\chaptermark}[1]{\markboth{\CTEXthechapter\hspace{1em}#1}{}}
    \newcommand{\commonhead}
    {
        \fancyhead{}
        \fancyhead[C]{\zihao{-5} \songti \leftmark}  % 篇眉：五号字居中，中文宋体
...
% TOC title format
\renewcommand{\cfttoctitlefont}{\hfill\heiti\zihao{3}}\renewcommand{\cftaftertoctitle}{\hfill}
\renewcommand{\cftloftitlefont}{\hfill\heiti\zihao{3}}\renewcommand{\cftafterloftitle}{\hfill}
\renewcommand{\cftlottitlefont}{\hfill\heiti\zihao{3}}\renewcommand{\cftafterlottitle}{\hfill}
\renewcommand{\cftloatitlefont}{\hfill\heiti\zihao{3}}\renewcommand{\cftafterloatitle}{\hfill}
